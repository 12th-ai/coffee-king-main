...
<head>
    ...
    <title>Coffe-King || Gallery</title>
...
<body>
    <header id="mainHeader" class="header">
        <div class="header-cont container">
            ...
            <nav id="navMenu">
                ...
                <a href="../blog/">Blog</a>
                <a href="#" class="activeNav">Gallery</a>
    ...
    <div class="gallery">
        <div class="gallery-cont container">
            <div class="gallery-crds">
                <?php 
                    $get = mysqli_query($conn, "SELECT * FROM gallery ORDER BY ID DESC");
                    while($row = mysqli_fetch_array($get)){
                        $name = $row['Img_Name'];
                ?>
                <div class="gallery-crd">
                    <img src="../../assets/gallery/<?php echo $name?>" alt="">
                </div>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="footer-cont container">
            ...
            <div class="footer-cont-scnd footer-crds">
                ...
                <div class="footer-cont-scnd-blw">
                    ...
                    <a href="../about/about/">About Us</a>
                    <a href="../explore/shop/">Shop</a>
                    <a href="#" class="footeractive">Gallery</a>
                </div>
            </div>
