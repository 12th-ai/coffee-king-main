            ...
            <nav id="navMenu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-cnt prod-drop" id="nav2">
                        <a href="#" class="activeDrop">Shop</a>
                        <a href="../cart/">Cart</a>
                ...
                ?>
                    <div class="product-crd">
                        <div class="product-crd-img">
                            <img src="../../../assets/products/<?php echo $pic ?>" alt="<?php echo $name ?>">
                        </div>
                        <a href='./product/?product=<?php echo $id ?>'><?php echo $name ?></a>
                        <p class="briefProduct"><?php echo $brief ?></p>
        ...
        <div class="footer-cont container">
            ...
            <div class="footer-cont-scnd footer-crds">
                ...
                <div class="footer-cont-scnd-blw">
                    ...
                    <a href="../../about/about/">About Us</a>
                    <a href="#" class="footeractive">Shop</a>
                    <a href="../../gallery/">Gallery</a>
                </div>
            </div>
