...
if (isset($_GET['member'])) {
    $id = $_GET['member'];
    $sql = mysqli_query($conn, "SELECT * FROM team WHERE ID = $id");
    while ($row = mysqli_fetch_array($sql)) {
        ...
        $tl = $row['Twitter_Link'];
        $ig = $row['IG_Link'];
        $linkedin = $row['Linked_In_Link'];
        $about = $row['About'];
        $expmaking = $row['Coffee_Making_Experience'];
        $expwaiter = $row['Cafe_Waiter_Experience'];
        $skillwaiter = $row['Cafe_Waiter_Skill'];
        $skillmaker = $row['Coffee_Maker_Skill'];
        $skillbarista = $row['Barista_Skill'];
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Coffee-King || <?php if (!isset($_GET['member']) || mysqli_num_rows($sql) == 0) {
                                echo "Error";
                            } else {
                                echo $name;
                            } ?></title>
    <link rel="shortcut icon" href="../../../../assets/09/cropped-favicon-100x100.png" type="image/x-icon">
    <?php if (!isset($_GET['member']) || mysqli_num_rows($sql) == 0) { ?>

        <link rel="stylesheet" href="../../../../css/404/main.css">
    <?php } ?>
    <link rel="stylesheet" href="../../../../css/about/team/team_member/main.css">
</head>
...
<body>
    ...
    if (!isset($_GET['member']) || mysqli_num_rows($sql) == 0) {
        ...
        <div class="home-mini">
            <div class="home-mini-cont container">
                ...
                <div class="home-mini-links">
                    ...
                    <a href="../" class="activeHomeMini">Team</a>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 26 26">
                        <path d="M11.414063 3.585938L8.585938 6.414063L15.171875 13L8.585938 19.585938L11.414063 22.414063L20.828125 13Z" />
                    </svg>
                    <p><?php echo $name ?></p>
        ...
        <div class="member">
            <div class="member-cont container">
                <div class="member-cont-top">
                    <div class="member-cont-top-left">
                        <div class="member-cont-top-left-img">
                            <img src="../../../../assets/team/<?php echo $img ?>" alt="">
                        </div>
                        <div class="member-cont-top-left-cnt">
                            <h1><?php echo $name ?></h1>
                            <p><?php echo $position ?></p>
                            <div class="member-cont-top-left-cnt-stats">
                                <p>
                                    <span>Age:</span> <?php echo $age ?>
                                </p>
                                <p>
                                    <span>Experience:</span> <?php echo $exp ?> Years
                                </p>
                                <p>
                                    <span>Specialization:</span> <?php echo $position ?>
                                </p>
                            </div>
                            <div class="member-cont-top-left-cnt-contact">
                                <h1>Contact</h1>
                                <a href="tel:<?php echo $phone ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48">
                                        <path d="M7,9v3.6C7.1,25.8,24.1,40.9,35.4,41l3.7,0c1,0,1.9-0.8,1.9-1.9l0-7.1c0-1-0.9-1.9-1.9-1.9L31,30l-4.1,4.3c-2.6,0-13.1-10.5-13.2-13.2L18,17V8.9c0-1-1-1.9-2-1.9H8.9C7.8,7,7,8,7,9" />
                                    </svg>
                                    <?php echo $phone ?>
                                </a>
                                <a href="mailto:<?php echo $email ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 24 24">
                                        <path d="M4 4C2.897 4 2 4.897 2 6L2 18C2 19.103 2.897 20 4 20L20 20C21.103 20 22 19.103 22 18L22 6C22 4.897 21.103 4 20 4L4 4 z M 4 6L20 6L20 6.0058594L12 11L4 6.0039062L4 6 z M 4 8.0039062L12 13L20 8.0058594L20.001953 18L4 18L4 8.0039062 z" />
                                    </svg>
                                    <?php echo $email ?>
                                </a>
                            </div>
                            <div class="member-cont-top-left-cnt-socials">
                                <a href="<?php echo $fb ?>">
                    ...
                    <div class="member-cont-top-right">
                        <form action="">
                            <input type="text" value="To: <?php echo $email ?>" disabled readonly>
                            <input type="text" name="names" id="name" placeholder="Your Names..." pattern="[a-z A-Z ']+" minlength="2" required>
                            <input type="email" name="email" id="email" placeholder="Your Email..." required>
                            <input type="text" name="country" id="country" placeholder="Residence Country..." pattern="[a-z A-Z 0-9]+" required>
                            <textarea name="message" id="message" placeholder="Your Message..." minlength="10" required></textarea>
                            <button type="submit" class="more">Send</button>
                        </form>
                    </div>
                </div>
                <div class="member-cont-btm">
                    <div class="member-cont-btm-crd">
                        <h1>About <?php echo $position ?></h1>
                        <p><?php echo $about ?></p>
                        <?php
                        $ss = mysqli_query($conn, "SELECT * FROM blog WHERE Journalist = $id");
                        if ($position == 'Blog Writer' && mysqli_num_rows($ss) > 0) { ?>
                            <a href='../../../blog/?author=<?php echo $id ?>' class="more more-btn">My Blogs</a>
                        <?php } ?>
                    </div>
                    <div class="member-cont-btm-crd">
                        <h1>Experience</h1>
                        <div class="member-cont-btm-crd-acc">
                            <div class="faq-btn activeFaqBtn">
                                <h3>
                                    Coffee Making
                                    <img src="../../../../assets/chevron-down.svg" alt="Up">
                                </h3>
                                <div class="faq-btn-inner">
                                    <p><?php echo $expmaking ?></p>
                                </div>
                            </div>
                            <div class="faq-btn">
                                <h3>
                    ...
                    <div class="member-cont-btm-crd">
                        <h1>Skills</h1>
                        <div class="member-cont-btm-crd-skills">
                            <div class="member-cont-btm-crd-skill-card" data-skill="<?php echo $skillwaiter ?>">
                                <p>Cafe Waiter</p>
                                <p><?php echo $skillwaiter ?>%</p>
                                <div class="skill-card-abs"></div>
                            </div>
                            <div class="member-cont-btm-crd-skill-card" data-skill="<?php echo $skillmaker ?>">
                                <p>Coffee Maker</p>
                                <p><?php echo $skillmaker ?>%</p>
                                <div class="skill-card-abs"></div>
                            </div>
                            <div class="member-cont-btm-crd-skill-card" data-skill="<?php echo $skillbarista ?>">
                                <p>Barista</p>
                                <p><?php echo $skillbarista ?>%</p>
                                <div class="skill-card-abs"></div>
                            </div>
                        </div>
                    </div>
