...
<body>
            ...
            <nav id="navMenu">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-cnt ab-drop" id="nav">
                        ...
                        <a href=".#" class="activeDrop">Team</a>
                        <a href="../faq/">FAQ</a>
                    </div>
                </div>
                <div class="dropdown">
    ...
    <div class="team-cover">
        <div class="team-cover-cont container">
            <?php
            ...
            ?>
                <div class="team-crd">
                    <a href='./member/?member="<?php echo $id?>"' class="team-crd-top">
                        <div class="team-crd-top-img">
                            <img src="../../../assets/team/<?php echo $img ?>" alt="">
                        </div>
                        <h2><?php echo $name ?></h2>
                    </a>
                    <p><?php echo $position ?></p>
                    <div class="team-crd-socials">
                        <a href="<?php echo $ig ?>">
