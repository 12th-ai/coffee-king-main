            ...
            <div class="main-right-btm oth-right-btm">
                ...
                <div class="oth-right-btm-table">
                    <table>
                        ...
                        <?php
                        $sql = mysqli_query($conn, "SELECT * FROM pro_replies");
                        while ($galrow = mysqli_fetch_array($sql)) {
                            ...
                            $date = $galrow['Date'];
                            $prod = $galrow['ProdID'];
                            $query = mysqli_query($conn, "SELECT * FROM product WHERE ID = $prod");
                            $get = mysqli_fetch_array($query);
                            $prodname = $get['Product_Name'];
                            $query1 = mysqli_query($conn, "SELECT * FROM pro_comments WHERE ID = $comment");
