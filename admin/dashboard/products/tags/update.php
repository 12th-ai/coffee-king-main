...
<?php
$id = $_GET['updateId'];
$query = "SELECT * FROM pro_tags WHERE ID = $id";
...
if (isset($_POST['update'])) {
    ...
    if (mysqli_num_rows($query) > 0) {
        ...
        $sql = mysqli_query($conn, "UPDATE `pro_tags` SET `Tag_Name` = '$name' WHERE ID = $id");
        if ($sql) {
                    ...
                    <div class="form-grp">
                        <div class="">
                            <div class="form-grp-inner-sp">
                                ...
                                <input type="text" name="tag" value="<?php echo $name?>" required="" placeholder="Enter Tag Name">
                            </div>
                        </div>
                    </div>
                    <div class="btns">
